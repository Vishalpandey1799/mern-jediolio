...
const QrCode = () => {
  ...
  useEffect(() => {
    ...
    img.src =
      ...
      "https://imgs.search.brave.com/tmb-_ppokg0tf9t1IdHCzHLn35Ap2LjgJmiGPy_xF3w/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly9pLnBp/bmltZy5jb20vb3Jp/Z2luYWxzLzlmLzE2/LzcyLzlmMTY3Mjcx/MGNiYTZiY2IwZGZk/OTMyMDFjNmQ0YzAw/LmpwZw";
  ...
  return (
    <div className="flex flex-col gap-4 p-6 bg-white rounded-lg shadow-md max-w-sm mx-auto h-[400px]">
      ...
      <div className="flex justify-between items-center">
        <span className="text-lg font-semibold text-amber-950 border border-gray-800 p-1">
          Profile QR
        </span>
        <button
      ...
      <div ref={qrCodeRef} className="relative flex justify-center mt-4">
        <QRCodeSVG
          value={`https://jediolio.vercel.app/user/portfolio/${newSlug}`}
          size={250}
          fgColor="#000000"
          bgColor="#ffffff"
          level="H"
